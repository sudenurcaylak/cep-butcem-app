...
class _ThemeSettingsScreenState extends State<ThemeSettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Tema ayarları yüklenemedi: $e')));
    }
  }

  Future<void> _selectTheme(String themeMode) async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Tema tercihi kaydedildi')));
    } catch (e) {
      if (!mounted) return;

      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Tema kaydedilemedi: $e')));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final selectedTheme = _settings.themeMode;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _SectionTitle(title: 'Görünüm', isDark: isDark),
                ...
                if (_isLoading)
                  ...
                  Column(
                    children: [
                      _ThemeCard(
                        ...
                        children: [
                          _ThemeOptionItem(
                            ...
                            title: 'Koyu Mod',
                            subtitle: 'Şu an kullanılan tema',
                      ...
                      Text(
                        'İleride açık tema ve sistem teması seçenekleri eklenecek.',
...
class _ThemeCard extends StatelessWidget {
  const _ThemeCard({required this.children, required this.isDark});
